package com.nanami.keys;
// Add the API keys that you wanted to use here.
...
public interface  API_keys {
    ...
    public static final String ELEVENLABS_API_KEY = "sk_c3127597ebef2168fcd1e9d9846d645608e0a1e57f03fc25";
